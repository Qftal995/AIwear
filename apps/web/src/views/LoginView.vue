...
<template>
  <div class="login">
    <a href="/" class="login-top-logo" aria-label="AIWear">
      <span class="login-top-logo-text">AIWear</span>
    </a>
      ...
      <section class="panel">
        <header class="brand">
          <div class="brand-logo">
            <span class="brand-logo-text">AIWear</span>
          </div>
          <div class="brand-product">衣衿知・数字衣橱</div>
        </header>
